...
## Environments
- Preview: https://main--elsevier-local-storefront--mohan-gs.aem.page/
- Live: https://main--elsevier-local-storefront--mohan-gs.aem.live/
...
1. Open the `elsevier-local-storefront` directory in your favourite IDE and start coding :)
